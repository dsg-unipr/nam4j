...
/**
 * <p>
 * This class represents a message to send a chunk of a dependency.
 * </p>
 * 
 * <p>
...
public class DependencyChunkTransferMessage extends BasicMessage {

	public static final String MSG_KEY = "DEPENDENCY_CHUNK_MSG";

	public DependencyChunkTransferMessage(PeerDescriptor peerDesc, DependencyChunk chunk) {
		super();
