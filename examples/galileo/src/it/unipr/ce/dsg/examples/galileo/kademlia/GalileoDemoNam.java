package it.unipr.ce.dsg.examples.galileo.kademlia;
...
public class GalileoDemoNam extends NetworkedAutonomicMachine {
	...
	public void setCfm(KademliaFunctionalModule cfm) {
		this.kfm = cfm;
	}
	...
	public GalileoDemoNam(String[] args) {
		...
		kfm = new KademliaFunctionalModule(this, args[1]);
	 ...
	 * 
	 * args[5]: a latitude value
	 * 
	 * args[6]: a longitude value
	 */
	public static void main(String[] args) {
		...
		if (args[0].equals("GALILEO_MINIMUM")) {
			
			/*
			 * Just enters Kademlia network Use the node options to interact
			 * with the remaining peers
			 */
			
		} else if (args[0].equals("GALILEO_LOOKUP")) {

			mccdemonam.getRfm().startTemperatureNotificationLookup(args[3],
